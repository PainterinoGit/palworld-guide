...
const RESOURCE_CATALOG = [
    ...
    { id: 'crude-oil', name: 'Rohöl', category: 'Flüssigkeit', early: 'Öl-Nodes an der Küste; in 1.0.3 sind Extraktoren günstiger und schneller', durable: 'Ölextraktor auf Öl-Nodes', locations: 'Oasis Isle; Ölstandorte im Meer', coords: '(885, 195) · (396, -466)', rarity: 'Sehr selten', note: 'Für Plasteel und spätere Produktion; 3-Nodes-Spots sind besonders wertvoll. Beide Extraktortypen zählen seit 1.0.3 für die Base-Mission.', image: 'oil_s1' },
    ...
    { id: 'dog-coin', name: 'Dog Coin', category: 'Währung', early: 'Dungeons, Salvage und seltene Gegner', durable: 'Endgame: Yakumo mit Service Minded/Lavish Hospitality für Mammorest-Captures; alternativ Dusty-Ravine-Mimog-Loop, World Tree und Expeditionen', locations: 'Dusty Ravine; World Tree; Dungeons; Feybreak', coords: '—', rarity: 'Selten', note: 'Für Starfruit, Handbooks und späte Aufwertungen. Die Capture-Route kann laut Praxistest etwa 608–800 Dog Coins pro Mammorest liefern; Werte hängen von Passives, Einstellungen und Glück ab. Nicht mit Gold verwechseln.', image: null },
    ...
    { id: 'world-tree-holy-water', name: 'World Tree Holy Water', category: 'World-Tree-Material', early: 'World-Tree-Pals, Teafant-Quellen und Expeditionen', durable: 'World-Tree-Farm, Expeditionen, World-Tree-Fischen und großer Fischteich', locations: 'World Tree', coords: 'Außerhalb der Basiskarte', rarity: 'Sehr selten', note: 'Seit 1.0.3 gibt es passive Quellen: Expeditionen, World-Tree-Fischen und große Fischteiche. Teafant-Quellen geben 30 Stück; das Gewicht wurde auf 0,1 gesenkt und der Buff hält länger. Die aktive Pal-Farm bleibt die schnellste Methode.', image: null },
    ...
    { id: 'ancient-pal-manuscript', name: 'Ancient Pal Manuscript', category: 'Endgame-Forschung', early: 'Pal-Expeditionen ab Level 15 (Pal Expedition Station)', durable: 'Dauerhafter Einsatz von High-Risk-Expeditionen (z. B. Spirit Blossom Cave, Forest’s Secret Realm)', locations: 'Pal Expedition Station in der Basis', coords: '—', rarity: 'Sehr selten', note: 'Exklusiv für Forschungen im Pal Labor Research Lab (permanente Basis- und Worker-Buffs). Droppt NICHT von Alpha-Bossen oder beim Schlachten; Expeditionen mit High-Level-Pals sind die einzige Quelle.', image: null },
    { id: 'ancient-technical-manual', name: 'Ancient Technical Manual', category: 'Buch / Tech-Punkte', early: 'Endboss-Truhen in High-Level-Dungeons', durable: 'Wildlife Sanctuaries (Inseln 1, 2 und 3 mit schnellem Flug-Mount abfliegen und Truhen looten)', locations: 'Dungeons; Wildlife Sanctuaries 1–3', coords: 'Sanctuaries auf See', rarity: 'Selten', note: 'Gewährt beim Lesen Antike Technologie-Punkte. Regelmäßige Kisten-Runs auf den drei Sanctuary-Inseln sind die zuverlässigste aktive Farm.', image: null },
];
