...
const BASE_PLANS = {
  ...
  2: {
    ...
    bases: [
      { name: 'Produktionsbase', purpose: 'Erz, Strom, Nahrung und Fertigung mit kurzen Laufwegen.', workers: ['1× Aegidron · Mining 8', '1× Orserk · Electricity', '1× Renjishi · Kindling 8', '1× Solenne · Handiwork 8', '2× Dandilord · Planting 8', '2× Shaolong · Watering 8', '2× Knocklem · Transporting', '1× Silvance · Medicine 8', '1× Lyleen · Planting-Reserve', '1× Wumpo · Transport-Reserve', '1× Frostallion · Cooling-Reserve', '1× Cattiva · Übergangs-Transport'], buildings: 'Erzbrunnen, 2× Beerenplantage, 2× Salatplantage, Kühler, Öfen, Assembly Lines, Medizin- und Lagerbereich.', note: '12 Worker-Slots einplanen: Kernbesetzung zuerst, Reserve-Pals nur bei Engpässen oder Schichtwechsel einsetzen. Beeren sichern das Worker-Futter; Salat ist das Arbeits-Food. Diese Base braucht keine Kuchen-Ranch.', sources: SOURCES },
      { name: 'Breeding- & Ranchbase', purpose: 'Kuchen, Ranch-Drops, Zuchtfarm und Inkubatoren ohne Produktionschaos.', workers: ['2× Chikipi · Ranch für Eier', '2× Mozzarina · Ranch für Milch', '2× Beegarde · Ranch für Honig', '1–2× Dandilord · Planting', '1× Shaolong · Watering', '1× Renjishi · Kuchenproduktion', '1× Bastigor · Cooling', '1–2× Knocklem · Transporting', '1× Vixy · Ranch-Reserve', '1× Cremis · Ranch-Reserve', '1× Sibelyx · Ranch für hochwertige Wolle', '1× Lyleen · Planting-Reserve'], buildings: 'Mehrere Breeding Farms, 2× Weizenplantage, 1× Beerenplantage, 3× getrennte Ranches (Eier/Milch/Honig), Küche, Inkubatoren, Kühler und ein zentrales Lager.', note: '12 Worker-Slots einplanen: Eier, Milch und Honig laufen dauerhaft; Vixy, Cremis und Sibelyx sind optionale Ranch-/Drop-Reserve. Kuchenproduktion: Weizen → Mehl plus Beeren. Zuchteltern nur mit gewünschten Passives/Talenten verwenden.', sources: SOURCES }
    ]
  },
  3: {
    baseCount: 3,
